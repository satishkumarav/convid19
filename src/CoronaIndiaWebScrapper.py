...
# Write region wise data in time series CSV file
utc = pytz.utc
...
f.write(tsdata.to_csv(index=False,
                      columns=["Date", "NameofState/UT", "Totalconfirmed", "TotalConfirmedcases(ForeignNational)",
                               "TotalConfirmedcases(IndianNational)", "Cured/Discharged/Migrated", "Death",
                               "MortalityRate"]))
f.close()
